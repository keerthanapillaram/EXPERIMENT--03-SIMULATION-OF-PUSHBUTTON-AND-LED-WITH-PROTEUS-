...
/ / USER CODE END Header / / Includes ------------------------------------------------------------------*/ #include "main.h" #include "stdbool.h" bool buttonstatus; void pushbutton();
...
/* Infinite loop / / USER CODE BEGIN WHILE / while (1) { pushbutton(); / USER CODE END WHILE */

/* USER CODE BEGIN 3 */
} /* USER CODE END 3 */ }

void pushbutton() { buttonstatus= HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_13); if(buttonstatus==0) { HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_RESET); HAL_Delay(2000); HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_SET); HAL_Delay(2000); } else { HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_RESET); } } /**
...
/*Configure GPIO pin : PC13 */ GPIO_InitStruct.Pin = GPIO_PIN_13; GPIO_InitStruct.Mode = GPIO_MODE_INPUT; GPIO_InitStruct.Pull = GPIO_PULLUP; HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
